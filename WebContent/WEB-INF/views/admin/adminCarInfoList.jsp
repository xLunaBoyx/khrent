...
%>
	...
	<style>
    div#search-carName {display: <%= searchType == null || "carCode".equals(searchType) ? "inline-block" : "none" %>; }
    div#search-maker {display: <%= "carName".equals(searchType) ? "inline-block" : "none" %>;}
    div#search-fuel {display: <%= "carName".equals(searchType) ? "inline-block" : "none" %>;}
    div#search-carSize {display: <%= "numberPlate".equals(searchType) ? "inline-block" : "none" %>;}
    </style>
...
%>            
	    ...
	    <div id="search-container">
	        ...
	        <div id="search-carName" class="search-type">
	            <form action="<%=request.getContextPath()%>/admin/carInfoFinder">
	        ...
	        <div id="search-maker" class="search-type">
     	    ...
     	    <div id="search-carSize" class="search-type">
	            <form action="<%=request.getContextPath()%>/admin/carInfoFinder">
	                <input type="hidden" name="searchType" value="car_size"/>
