...
%>
				<tr>
            		...
            		<td>
            		<input type="button" value="변경" class="adminCarUpdateBtn" onclick="location.href='<%= request.getContextPath() %>/admin/adminReservationUpdate?reserNo=<%= reservation.getReserNo() %>';"/>
            		</td>
            	</tr>
<%		
	}
