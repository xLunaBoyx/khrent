...
렌트킹 대표번호 1544-9970 으로 문의를 주시면 별도로 답변드리고 있습니다.<br />
<br />
...
감사합니다.</p>
							        ...
							        <li class="article" id="a8">
							            <p class="q"><a href="#a8">Q. 렌트킹 예약 취소 규정 및 취소수수료에 대해 알고 싶어요</a></p>
...
<br />
5. 자연재해로 인한 결박 : 결박 확인서를 발급받아 렌트킹 카톡으로 전달 후 100% 취소<br />
<br />
...
렌트킹 사이트 내 마이페이 결제내역에서 연장결제 하시면 됩니다.<br />
...
<br />	
렌트킹의 자차손해면책제도는 각 대여업체마다 설정한 자차보험이 있으며 면책금 구간으로 검색이 가능합니다.<br />	 적용 가능한 보험은 제휴 렌트카 회사별, 차량별로 다를
수 있습니다.<br />	
<br />	
