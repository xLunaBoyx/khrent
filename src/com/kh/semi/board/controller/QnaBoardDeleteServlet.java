 ...
 */
@WebServlet("/board/qnaBoardDelete")
public class QnaBoardDeleteServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2.업무로직
		Attachment attach = questionBoardService.selectOneQnaAttachment(no);
		...
		int result = questionBoardService.deleteQnaBoard(no);
		...
		String location = request.getContextPath() + "/board/questionList";
