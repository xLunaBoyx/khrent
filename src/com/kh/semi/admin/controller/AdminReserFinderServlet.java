 ...
 */
@WebServlet("/admin/adminReservationFinder")
public class AdminReserFinderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2. 업무로직
		// 	가. content영역
		List<Reservation> list = adminService.searchReservation(param);
		System.out.println(list);
		
		// 	나. pagebar영역
		//  totalContents

		int totalContents = adminService.searchReservationCount(param);
