...
/**
 * Servlet implementation class AdminCarListFinderServlet
 */
@WebServlet("/admin/carListFinder")
public class AdminCarListDeleteFinderServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2. 업무로직
		// 	가. content영역
		List<CarList> list = adminService.searchCarList(param);
		System.out.println(list);
		
		// 	나. pagebar영역
		//  totalContents

		int totalContents = adminService.searchCarListCount(param);
