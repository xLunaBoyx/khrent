 ...
 */
@WebServlet("/admin/adminCarInfoDeleteList")
public class AdminCarInfoDeleteListServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 2.업무로직
		// a.content영역
		List<CarInfo> list = adminService.selectTotalCarInfo(startRownum, endRownum);
